...
class FormsPage {
    get loginMenuButton() { return $('~Forms'); }
    get textFormComponents() {return $('//android.widget.TextView[@text="Form components"]');}
    ...
    get dropDown() { return $('~android_touchable_wrapper'); }
    get dropDownSelectAn() { return $('//android.widget.CheckedTextView[@resource-id="android:id/text1" and @text="Select an item..."]'); }
    get dropDownWebdriverio() { return $('//android.widget.CheckedTextView[@resource-id="android:id/text1" and @text="webdriver.io is awesome"]'); }
    get dropDownAppium() { return $('//android.widget.CheckedTextView[@resource-id="android:id/text1" and @text="Appium is awesome"]'); }
    get dropDownThisApp() { return $('//android.widget.CheckedTextView[@resource-id="android:id/text1" and @text="This app is awesome"]'); }
